...
export const STRINGS = {
  es: {
    ...
    feat_holidays_desc: "Consulta los días festivos oficiales de {n} países para cualquier año.",
    ...
    dash_next_days: "días para el próximo feriado",
    dash_observed: "Se descansa el {date}",
  ...
  en: {
    ...
    feat_holidays_desc: "Look up the official public holidays of {n} countries for any year.",
    ...
    dash_next_days: "days until the next holiday",
    dash_observed: "Day off observed on {date}",
